...
// useRuntimeConfig isn't defined outside Nuxt (e.g. better-auth CLI) — fall back to env.
let betterAuthConfig = { secret: process.env.NUXT_BETTER_AUTH_SECRET, url: process.env.NUXT_BETTER_AUTH_URL };
try {
  betterAuthConfig = useRuntimeConfig().betterAuth;
} catch {}
